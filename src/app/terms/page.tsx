  ...
  return (
    <div className="container max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <p>
          Welcome to Business App. These Terms of Service govern your use of our
        ...
        <p>
          Our platform provides tools for business management, employee time-off
          tracking, and company administration. You agree to use these services
          only for their intended purposes and in compliance with all applicable
        ...
        <p>
          ...
          owned by Business App and are protected by international copyright,
        ...
        <p>
          ...
          to other users of the Service, our business, or third parties, or for
          any other reason.
        </p>
        ...
        <p>
          In no event shall Business App, nor its directors, employees,
        ...
        <p>
          ...
          provide at least 30 day&apos;s notice prior to any new terms taking effect.
